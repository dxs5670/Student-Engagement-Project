...
document.getElementById("currentMonth").innerHTML = months[thisMonth] + " " + thisYear;

//Create event listeenrs for forward ad back buttons
document.getElementById("calendarLastButton").addEventListener("click", lastMonth)
document.getElementById("calendarNextButton").addEventListener("click", nextMonth)
